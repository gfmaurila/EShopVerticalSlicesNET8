using API.Webhooks.Domain.User.Events;
using API.Webhooks.Feature.Users.GetUser;
using API.Webhooks.Infrastructure.Database.Repositories.Interfaces;
using MediatR;
using poc.core.api.net8.Interface;

namespace API.Webhooks.Feature.Users.UpdateUser.Events;
