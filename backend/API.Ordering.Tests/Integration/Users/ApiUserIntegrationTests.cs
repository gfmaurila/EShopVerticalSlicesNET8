using API.Ordering.Feature.Users.CreateUser;
using API.Ordering.Feature.Users.DeleteUser;
using API.Ordering.Feature.Users.GetUser;
using API.Ordering.Feature.Users.UpdateEmail;
using API.Ordering.Feature.Users.UpdatePassword;
using API.Ordering.Feature.Users.UpdateUser;
using API.Ordering.Tests.Integration.Features.Auth.AuthEndpoint;
using API.Ordering.Tests.Integration.Features.Users.Data;
using API.Ordering.Tests.Integration.Users.Data;
using API.Ordering.Tests.Integration.Users.Fakes;
...
namespace API.Ordering.Tests.Integration.Users;
