using API.Ordering.Feature.Auth.AuthNewPassword;
using API.Ordering.Feature.Auth.Login;
using API.Ordering.Feature.Auth.ResetPassword;
using Bogus;

namespace API.Ordering.Tests.Integration.Features.Auth.Fakes;
