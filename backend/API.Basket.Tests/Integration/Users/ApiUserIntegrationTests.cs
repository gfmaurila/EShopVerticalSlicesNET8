using API.Basket.Feature.Users.CreateUser;
using API.Basket.Feature.Users.DeleteUser;
using API.Basket.Feature.Users.GetUser;
using API.Basket.Feature.Users.UpdateEmail;
using API.Basket.Feature.Users.UpdatePassword;
using API.Basket.Feature.Users.UpdateUser;
using API.Basket.Tests.Integration.Features.Auth.AuthEndpoint;
using API.Basket.Tests.Integration.Features.Users.Data;
using API.Basket.Tests.Integration.Users.Data;
using API.Basket.Tests.Integration.Users.Fakes;
...
namespace API.Basket.Tests.Integration.Users;
