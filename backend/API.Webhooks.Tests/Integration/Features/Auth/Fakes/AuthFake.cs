using API.Webhooks.Feature.Auth.AuthNewPassword;
using API.Webhooks.Feature.Auth.Login;
using API.Webhooks.Feature.Auth.ResetPassword;
using Bogus;

namespace API.Webhooks.Tests.Integration.Features.Auth.Fakes;
