using API.Catalog.Feature.Users.CreateUser;
using API.Catalog.Feature.Users.DeleteUser;
using API.Catalog.Feature.Users.GetUser;
using API.Catalog.Feature.Users.UpdateEmail;
using API.Catalog.Feature.Users.UpdatePassword;
using API.Catalog.Feature.Users.UpdateUser;
using API.Catalog.Tests.Integration.Features.Auth.AuthEndpoint;
using API.Catalog.Tests.Integration.Features.Users.Data;
using API.Catalog.Tests.Integration.Users.Data;
using API.Catalog.Tests.Integration.Users.Fakes;
...
namespace API.Catalog.Tests.Integration.Users;
